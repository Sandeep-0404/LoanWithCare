package com.example.loan_help2.Authentication;
...
import com.example.loan_help2.MainActivity;
import com.example.loan_help2.R;
import com.example.loan_help2.pan_validation;
import com.example.loan_help2.verhoeff;
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    if (response.getBoolean("success")) {
                        ...
                        Toast.makeText(bank_details.this, "User Registered Successfully!", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof ServerError && response != null) {
                    try {
                        ...
                        Toast.makeText(bank_details.this, obj.getString("msg"), Toast.LENGTH_SHORT).show();
                        pb.setVisibility(View.GONE);
    ...
    private boolean checkFields() {
        if (Aadhar_no_string.isEmpty() || Pan_no_string.isEmpty() || Bank_no_string.isEmpty() || ifsc_string.isEmpty()) {
           // Toasty.error(this, "Please fill all the necessary details!").show();
            Toast.makeText(bank_details.this,"Please fill all the necessary details!", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
